...
void tests(String rootUrl) async {
  ...
  group('Elec calc cdf tests ISONE, 1 leg:', () {
    ...
    test('change calculator term and reprice', () async {
      ...
      await calc.build();
      expect(
          calc.legs.first.floatingPrice,
          TimeSeries<num>.fromIterable([
            IntervalTuple(Month(2021, 1, location: location), 58.25),
            IntervalTuple(Month(2021, 2, location: location), 55.75),
          ]));
    ...
    test('change calculator asOfDate and reprice', () async {
      ...
      await calc.build();
      expect(calc.legs.first.floatingPrice.first.value.toStringAsFixed(2), '60.70');
    ...
    test('change calculator bucket and reprice', () async {
      var calc = c1
        ..legs.first.bucket = IsoNewEngland.bucket7x8;
      await calc.build();
      expect(
          calc.legs.first.floatingPrice.intervals,
          [
    ...
    test('parse calculator without fixPrice', () async {
      ...
      expect(calc.dollarPrice(), 2560000);
    });
    test('flat report', () {
