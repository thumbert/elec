...
void tests() {
  group('Hourly schedule tests:', () {
    ...
    test('one value all hours', () {
      ...
      expect(
          hs.valueAt(Hour.beginning(TZDateTime(location, 2019, 1, 1, 4))), 10);
      var ts = hs.toHourly(Date(2019, 1, 4, location: location));
      expect(ts.values.toList(), List.filled(24, 10));
      expect(hs.toJson(), {'type': 'HourlySchedule.filled', 'values': 10});
    });
    test('one value by month', () {
      ...
      expect(
          hs.valueAt(Hour.beginning(TZDateTime(location, 2019, 5, 5, 4))), 5);
      expect(
          hs.valueAt(Hour.beginning(TZDateTime(location, 2019, 9, 5, 4))), 9);
      var ts = hs.toHourly(Date(2019, 1, 4, location: location));
    ...
    test('one value by bucket', () {
      ...
      expect(
          hs.valueAt(Hour.beginning(TZDateTime(location, 2019, 1, 1, 4))), 2);
      expect(
          hs.valueAt(Hour.beginning(TZDateTime(location, 2019, 5, 5, 4))), 2);
      expect(
          hs.valueAt(Hour.beginning(TZDateTime(location, 2019, 9, 5, 23))), 2);
      var ts = hs.toHourly(Date(2019, 1, 4, location: location));
      expect(
    ...
    test('one value by bucket and month', () {
      ...
      expect(
          hs.valueAt(Hour.beginning(TZDateTime(location, 2019, 1, 1, 4))), 1);
      expect(
          hs.valueAt(Hour.beginning(TZDateTime(location, 2019, 5, 5, 4))), 5);
      expect(
          hs.valueAt(Hour.beginning(TZDateTime(location, 2019, 9, 5, 23))), 9);
